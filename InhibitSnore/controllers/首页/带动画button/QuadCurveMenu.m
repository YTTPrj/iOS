...
#define NEARRADIUS 45.0f
#define ENDRADIUS 45.0f
#define FARRADIUS 45.0f
#define STARTPOINT CGPointMake(50, 430)
#define TIMEOFFSET 0.016f
...
- (id)initWithFrame:(CGRect)frame menus:(NSArray *)aMenusArray
{
    ...
    if (self) {
        ...
        for (int i = 0; i < count; i ++)
        {
            ...
            if (i==0) {
                item.endPoint = CGPointMake(STARTPOINT.x+ENDRADIUS*0.7071067812, STARTPOINT.y-ENDRADIUS*0.7071067812);
                item.nearPoint = CGPointMake(STARTPOINT.x+ENDRADIUS*0.7071067812, STARTPOINT.y-ENDRADIUS*0.7071067812);
                item.farPoint = CGPointMake(STARTPOINT.x+ENDRADIUS*0.7071067812, STARTPOINT.y-ENDRADIUS*0.7071067812);
            } else if(i==1){
                item.endPoint = CGPointMake(STARTPOINT.x + ENDRADIUS *0.96592582628907, STARTPOINT.y + ENDRADIUS *0.25881904510252);
                item.nearPoint = CGPointMake(STARTPOINT.x + NEARRADIUS *0.96592582628907, STARTPOINT.y + NEARRADIUS * 0.25881904510252);
                item.farPoint = CGPointMake(STARTPOINT.x + FARRADIUS *0.96592582628907, STARTPOINT.y + FARRADIUS * 0.25881904510252);
                NSLog(@"远点%d:%f  %f",i,item.farPoint.x,item.farPoint.y);
            }
        ...
        // add the "Add" Button.
        _addButton = [[QuadCurveMenuItem alloc] initWithImage:[UIImage imageNamed:@"增加图标"]
                                       highlightedImage:[UIImage imageNamed:@"增加图标"]
                                           ContentImage:nil
